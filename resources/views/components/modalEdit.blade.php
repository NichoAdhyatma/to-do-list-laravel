...
<div class="modal">
    <div class="modal-box relative">
        ...
        <div id="loader" class="flex items-center justify-center w-full mt-5">
        ...
        <p class="py-4">
        <form id="form-edit" action="" class="flex flex-col gap-4" method="post">
            @csrf
            @method('put')
            <select name="mahasiswa_id" id="mhs_id" class="select select-bordered w-full ">
            ...
            <label>Status</label>
            <div>
                <input id="active" type="radio" name="active" class="mr-2" value="active"><label for="active"
                    class="mr-5">active</label>
